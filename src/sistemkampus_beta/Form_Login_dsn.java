 ...
 * @author Fuad Hanif S
 */
public class Form_Login_dsn extends javax.swing.JFrame {
    Connection con;
    Statement stat;
    ResultSet rs;
    String sql;
    ...
    /**
     * Creates new form Form_Login_dsn
     */
    public Form_Login_dsn() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tUsername.setText("Masukkan NIP");
        ...
        Username.setBounds(60, 180, 240, 50);
        ...
        Password.setBounds(60, 240, 240, 52);
    ...
    private void bLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bLoginActionPerformed
        // TODO add your handling code here:
       try {
            sql = "select *from login_dosen where nip='"+tUsername.getText()+"' AND password='"+pPassword.getText()+"'";
            rs = stat.executeQuery(sql);
            if(rs.next()){
                if(tUsername.getText().equals(rs.getString("nip")) && pPassword.getText().equals(rs.getString("password")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Login_dsn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
